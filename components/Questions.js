...
function Questions() {
  return (
<div className="bg-[#fcfbf8]   md:pt-6 py-10 lg:py-16 px-4  md:px-6 lg:px-14 2xl:px-40 flex flex-col items-center text-center font-Sa" >
    {/* Frequently Asked Questions... */}
    <h2 className="font-CD font-bold text-[24px] sm:text-[40px] 2xl:text-[54px] leading-[36px] sm:leading-[50px] 2xl:leading-720px]  text-[rgb(88,48,25)]">Frequently Asked Questions</h2>
