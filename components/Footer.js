...
function Footer() {
  return ( 
      ...
      <div id="enroll" className=" bg-[rgb(88,48,25)] text-Sa px-4 sm:px-8 2xl:px-12  pt-10 pb-20  text-white text-[16px] sm:text-[20px] 2xl:text-[24px]  font-normal sm:flex justify-start items-start overflow-ellipsis space-y-10 sm:space-y-0">
        <div className='space-y-3  space-x-3 sm:w-1/4' >
           <h2 className='font-AK text-[36px]'>TT Robot</h2>
        ...
        <div className="  sm:w-1/4 space-y-3 lg:pr-3">
          ...
          <div><a href="#courses">Our Robots</a></div>
        ...
        <div className='flex '>
          <input placeholder='Nft123@gmail.com' className='w-2/4 lg:3/5 px-4 sm:px-3 lg:px-5 py-2  2xl:py-4 rounded-l-md bg-[#ffffff] text-[10px] sm:text-[12px] 2xl:text-[16px] text-[rgb(88,48,25)]'/>
          <button className=" w-1/4 sm:w-2/4 lg:w-2/5 px-4 sm:px-3 lg:px-5 py-2  2xl:py-4 rounded-r-md hover:brightness-75 hover:shadow-2xl bg-[rgb(145,107,42)] text-white text-[10px] sm:text-[12px] 2xl:text-[16px] font-bold ">Send Message</button>
        </div>
